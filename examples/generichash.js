...
var key1 = Buffer.allocUnsafe(sodium.crypto_generichash_KEYBYTES);
sodium.randombytes_buf(key1, sodium.crypto_generichash_KEYBYTES);
...
var key2 = Buffer.allocUnsafe(sodium.crypto_generichash_KEYBYTES);
sodium.randombytes_buf(key2, sodium.crypto_generichash_KEYBYTES);
