...
describe('crypto_box_easy', function() {
    it('crypto_box_easy should encrypt to known cipher text', function(done) {
        var cipherMsg = sodium.crypto_box_easy(plainText,nonce, bobpk, alicesk);
        if( !cipherMsg ) {
            should.fail();
        }
    ...
    it('should fail on bad param 1', function(done) {
        ...
        assert.throws(function() {
            var cipherMsg = sodium.crypto_box_easy(p, n, pk, sk);
        });
...
describe('crypto_box_open_easy', function() {
    ...
    it('should fail on bad argument 1', function(done) {
        ...
        assert.throws(function() {
            var plainMsg = sodium.crypto_box_open_easy(ctxt,n,pk, sk);
        });
