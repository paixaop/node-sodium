...
describe("Sign", function () {
    it("Example of signing a message ", function (done) {
        ...
        var signature = aliceSign.sign( "important signed message", "utf8");
...
describe("Auth", function () {
    it("Using authentication tokens ", function (done) {
        ...
        var restAPIKey = 'afcd09812fe556aac311de3faade13afcd09812fe556aac311de3faade13ade3';

        // User's request to the server
        var request = 'http://api.example.domain/query?keyid=' + restKeyID;
