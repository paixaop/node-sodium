...
describe("libsodium_aead_aes256gcm", function () {
    for(var i  = 0; i < tests.length; i++) {
        
        var key = Buffer.from(tests[i][0], 'hex');
        ...
        it('should have exported the right constants for vector ' + i, function() {
            assert(key.length == sodium.crypto_aead_aes256gcm_KEYBYTES);
            assert(nonce.length == sodium.crypto_aead_aes256gcm_NPUBBYTES);
            assert(mac.length ==  sodium.crypto_aead_aes256gcm_ABYTES);
        });
