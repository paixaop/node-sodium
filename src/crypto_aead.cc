...
NAN_METHOD(bind_crypto_aead_aes256gcm_encrypt_detached_afternm) {
    ...
    if( crypto_aead_aes256gcm_encrypt_detached_afternm(c_ptr, mac_ptr, NULL, m, m_size, ad, ad_size, NULL, npub, (crypto_aead_aes256gcm_state*)ctx) == 0 ) {
        ...
        Nan::DefineOwnProperty(result, Nan::New<String>("cipherText").ToLocalChecked(), c, v8::PropertyAttribute::DontDelete);
        Nan::DefineOwnProperty(result, Nan::New<String>("mac").ToLocalChecked(), mac, v8::PropertyAttribute::DontDelete);
