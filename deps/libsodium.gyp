{
    'targets': [{
            ...
            'sources': [
                    'libsodium-<(naclversion)/src/libsodium/crypto_aead/chacha20poly1305/sodium/aead_chacha20poly1305.c',
                    ...
                    'libsodium-<(naclversion)/src/libsodium/crypto_auth/hmacsha256/cp/hmac_hmacsha256.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_auth/hmacsha256/cp/verify_hmacsha256.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_auth/hmacsha512/auth_hmacsha512_api.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_auth/hmacsha512/cp/hmac_hmacsha512.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_auth/hmacsha512/cp/verify_hmacsha512.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_auth/hmacsha512256/auth_hmacsha512256_api.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_auth/hmacsha512256/cp/hmac_hmacsha512256.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_auth/hmacsha512256/cp/verify_hmacsha512256.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_box/crypto_box.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_box/crypto_box_easy.c',
                    ...
                    'libsodium-<(naclversion)/src/libsodium/crypto_hash/sha256/cp/hash_sha256.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_hash/sha512/hash_sha512_api.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_hash/sha512/cp/hash_sha512.c',
                    ...
                    'libsodium-<(naclversion)/src/libsodium/crypto_pwhash/scryptsalsa208sha256/crypto_scrypt-common.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_pwhash/scryptsalsa208sha256/scrypt_platform.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_pwhash/scryptsalsa208sha256/pbkdf2-sha256.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_pwhash/scryptsalsa208sha256/pwhash_scryptsalsa208sha256.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_pwhash/scryptsalsa208sha256/nosse/pwhash_scryptsalsa208sha256_nosse.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_pwhash/scryptsalsa208sha256/sse/pwhash_scryptsalsa208sha256_sse.c',
                    ...
                    'libsodium-<(naclversion)/src/libsodium/crypto_secretbox/crypto_secretbox_easy.c',
                    ...
                    'libsodium-<(naclversion)/src/libsodium/crypto_stream/chacha20/stream_chacha20_api.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_stream/chacha20/ref/stream_chacha20_ref.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_stream/salsa20/stream_salsa20_api.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_stream/salsa20/ref/stream_salsa20_ref.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_stream/salsa20/ref/xor_salsa20_ref.c',
                    ...
                    'libsodium-<(naclversion)/src/libsodium/crypto_verify/64/verify_64_api.c',
                    'libsodium-<(naclversion)/src/libsodium/crypto_verify/64/ref/verify_64.c',
                    ...
                    'libsodium-<(naclversion)/src/libsodium/sodium/runtime.c',
