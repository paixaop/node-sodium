...
var KeyPair = function() {
    ...
    self.init = function(options) {
        ...
        self.publicKey.init(options.publicKeySize, options.publicKey, options.encoding);
        self.secretKey.init(options.secretKeySize, options.secretKey, options.encoding);
    };
