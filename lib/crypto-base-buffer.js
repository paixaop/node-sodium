...
var CryptoBaseBuffer = function() {
     ...
     */
    self.init = function(expectedSize, value, encoding) {
        expectedSize.should.have.type('number').above(0);
    ...
    self.error = function(errorMessage) {
        return new Error("[CryptoBaseBuffer] " + errorMessage);
    }
    ...
    self.isValid = function(value, encoding) {
        ...
        if(typeof value == 'object' && (value instanceof Array || value instanceof Buffer) ) {
    ...
    self.generate = function() {
        ...
        self.baseBuffer = new Buffer(self.expectedSize);
...
module.exports = CryptoBaseBuffer;